...
class App(unittest.TestCase):
    ...
    def session(self):
        s = Session()
        s.mount(
            "http://", HTTPAdapter(max_retries=Retry(total=100, backoff_factor=0.1))
        )
        return s
    ...
    def test_events(self):
        ...
        self.assertEqual(200, r.status_code)
        self.assertEqual("text/event-stream; charset=utf-8", r.headers["content-type"])
            ...
            [
                {
                    "symbol": "clearsky_day",
                    "temperature": 19.3,
                    "time": "2020-08-17T16:00:00Z",
                },
                {
                    "symbol": "clearsky_day",
                    "temperature": 18.4,
                    "time": "2020-08-17T17:00:00Z",
                },
                {
                    "symbol": "clearsky_day",
                    "temperature": 17.3,
                    "time": "2020-08-17T18:00:00Z",
                },
                {
                    "symbol": "clearsky_day",
                    "temperature": 15.7,
                    "time": "2020-08-17T19:00:00Z",
                },
                {
                    "symbol": "clearsky_day",
                    "temperature": 14.0,
                    "time": "2020-08-17T20:00:00Z",
                },
                {
                    "symbol": "clearsky_day",
                    "temperature": 12.9,
                    "time": "2020-08-17T21:00:00Z",
                },
            ],
            data["today"]["forecast"],
        )
            ...
            [
                {
                    "symbol": "clearsky_day",
                    "temperature": 23.0,
                    "time": "2020-08-18T15:00:00Z",
                },
                {
                    "symbol": "clearsky_day",
                    "temperature": 22.4,
                    "time": "2020-08-18T16:00:00Z",
                },
                {
                    "symbol": "clearsky_day",
                    "temperature": 21.5,
                    "time": "2020-08-18T17:00:00Z",
                },
                {
                    "symbol": "clearsky_day",
                    "temperature": 20.3,
                    "time": "2020-08-18T18:00:00Z",
                },
                {
                    "symbol": "clearsky_day",
                    "temperature": 18.6,
                    "time": "2020-08-18T19:00:00Z",
                },
                {
                    "symbol": "clearsky_day",
                    "temperature": 16.9,
                    "time": "2020-08-18T20:00:00Z",
                },
            ],
            ...
            [
                {
                    "symbol": "clearsky_day",
                    "temperature": 23.3,
                    "time": "2020-08-18T14:00:00Z",
                },
                {
                    "symbol": "rainshowers_day",
                    "temperature": 22.4,
                    "time": "2020-08-19T12:00:00Z",
                },
                {
                    "symbol": "cloudy",
                    "temperature": 20.2,
                    "time": "2020-08-20T12:00:00Z",
                },
                {
                    "symbol": "partlycloudy_day",
                    "temperature": 22.5,
                    "time": "2020-08-21T12:00:00Z",
                },
                {
                    "symbol": "partlycloudy_day",
                    "temperature": 21.4,
                    "time": "2020-08-22T12:00:00Z",
                },
                {
                    "symbol": "rainshowers_day",
                    "temperature": 18.1,
...
class HackerNews(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        self.assertEqual("Building an OpenBSD Router", data["items"][3]["title"])
...
class Calendar(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        expected = [
            {"date": "2013-07-01T15:00:00+02:00", "id": "foo1", "summary": "Foo bar 1"},
            {"date": "2013-08-01T15:00:00+02:00", "id": "foo2", "summary": "Foo bar 2"},
        ]
...
class Avinor(unittest.TestCase):
    ...
    def test_parse(self):
        a = avinor.Avinor({"interval": None, "url": None, "from": "TRD", "to": "OSL"})
...
class Flybussen(unittest.TestCase):
    def _test_responses(self):
        ...
        stop_path = (
            "/server/wsapi/stop/format/json/p/web/v/1"
            "?action=departures&airport_code=TRD&product_id=1"
        )
        trip_path = (
            "/server/api/travel/format/json/p/web/v/1?data=%7B%22"
...
class Rss(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        self.assertEqual("Heilt likt i nedrykksstriden", data["items"][0]["title"])
...
class CreateDashboard(unittest.TestCase):
    def setUp(self):
        ...
        self.factory = DashboardFactory("foo", app_root=self.tmpdir, quiet=True)
